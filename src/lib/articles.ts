export type Article = {
  ...
  content: string;
  thumbnail: string;
  keywords: string[]; // New: for SEO keywords
  tags: string[]; // New: for categorization and display
};
...
const articles: Article[] = [
  {
    ...
    `,
    thumbnail: "https://via.placeholder.com/1200x600/FF5733/FFFFFF?text=Website+Modern",
    keywords: ["website", "bisnis", "digital", "online presence", "pengembangan web"],
  ...
  },
  {
    ...
    `,
    thumbnail: "https://via.placeholder.com/1200x600/33FF57/FFFFFF?text=SEO+Dasar",
    keywords: ["SEO", "optimasi mesin pencari", "digital marketing", "visibilitas website"],
  ...
  },
  {
    ...
    `,
    thumbnail: "https://via.placeholder.com/1200x600/3357FF/FFFFFF?text=E-commerce+Platform",
    keywords: ["e-commerce", "platform", "toko online", "bisnis online", "shopify", "woocommerce"],
    tags: ["E-commerce", "Bisnis Online", "Platform"],
  },
  {
    ...
    `,
    thumbnail: "https://via.placeholder.com/1200x600/FFC300/FFFFFF?text=Konten+Menarik",
    keywords: ["konten website", "strategi konten", "penulisan konten", "SEO konten"],
    tags: ["Konten", "Website", "Tips"],
  },
];
